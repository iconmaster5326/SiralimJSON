...
namespace SiralimDumper
{
    ...
    Sprite={Sprite.ToString().Replace("\n", "\n  ")},
        ...
        {
            mappings.GetAndAppend(Sprite.Name, values: SiralimDumper.ImagesForOWSprite(Sprite, SpriteFilenamePrefix));
        }
...
#nullable disable
            ...
            Name = Name,
            Notes = [],
            Sources = Reserved ? [] : [new() { Type = QuickType.SourceType.Everett, Cost = 10000 }],
...
#nullable enable
        ...
        public QuickType.ShopItemType ShopItemType => QuickType.ShopItemType.Costume;
    }
